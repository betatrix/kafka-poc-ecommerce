...
class KafkaService implements Closeable {
    ...
    KafkaService(String topic, ConsumerFunction parse, String className) {
        this.parse = parse;
        this.consumer = new KafkaConsumer<>(properties(className));
    ...
    private static Properties properties(String className) {
